...
<input type = "text" name = "legajo" readonly ="readonly" value ="<%=emp.getLegajo()%>"><input type="text" name="nombre" readonly value="<%=emp.getNombre() %>"></td>
...
<table align="center" border="2" width="40%" style="color: #000000; background-color: #A9D0F5; font-family:; border-left-color: #000000; border-top-color: #000000; border-right-color: #000000; border-bottom-color: #000000; height: 275px; border-top-style: solid; border-right-style: solid">
   ...
   <tr>
        ...
        <form action="EmpleadoServlet?action=opcionDepacho" method ="post">
	        	...
	        	<input type="submit" value="Despacho de Mercaderias" name="despacho" style="font-family:; font-style: normal; font-weight: bold; width: 203px; height: 30px; background-color: #BDBDBD">
        	</form>
        </td>
   </tr> 
   <tr>
        ...
        <td colspan="2" align="center" style="border-left-color: #000000; border-top-color: #000000; border-right-color: #000000; border-bottom-color: #000000">
        	<form action="EmpleadoServlet?action=opcionListaReposicion" method ="post">
	        	...
	        	<input type ="hidden" name = "nombre" readonly ="readonly" value ="<%=emp.getNombre()%>">
	        	<input type ="hidden" name = "legajo" readonly ="readonly" value ="<%=emp.getLegajo()%>">
	        	<input type="submit" value="Listas de Reposicion" name="listasReposicion" style="font-family:; font-style: normal; font-weight: bold; width: 203px; height: 30px; background-color: #BDBDBD">
        	</form>
        </td>
